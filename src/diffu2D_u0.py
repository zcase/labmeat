...
def lab_meat_diffuse(flowArray, size, dt, T):

    def initialFromFlows(x,y):
        # print(x, y)
...
if __name__ == '__main__':
    ...
    def center_point_initial(x, y):
        ...
        if(x==globalInitialPoint and y==globalInitialPoint):
            ...
            return 0
    def initialFromFlows(x,y,flowArray):
        return flowArray[x][y]
    ...
    solver_classic_iterative(myI, 1, None, size, size, size, size, .1, 6, user_action=myAction)
